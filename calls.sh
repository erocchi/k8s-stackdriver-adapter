...
# TODO examples
curl -k https://uber-adapter:443/apis/custom-metrics.metrics.k8s.io/v1alpha1/namespaces/default/metrics/to-do-metric-name
curl -k https://uber-adapter:443/apis/custom-metrics.metrics.k8s.io/v1alpha1/namespaces/*/to-do-metric-name
