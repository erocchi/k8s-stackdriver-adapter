...
func (p *incrementalTestingProvider) getMetricValuesFromResponse(groupResource schema.GroupResource, namespace string, response stackdriver.ListTimeSeriesResponse) (map[string]int64, error) {
...
func (p *incrementalTestingProvider) valuesFor(groupResource schema.GroupResource, metricName string, namespace string, metricFilter string, groupByFields []string) (map[string]int64, error) {
...
func (p *incrementalTestingProvider) metricsFor(values map[string]int64, groupResource schema.GroupResource, metricName string, list runtime.Object) (*custom_metrics.MetricValueList, error) {
